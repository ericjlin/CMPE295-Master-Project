import { Text, Alert, Image, Modal, TouchableOpacity, TouchableNativeFeedback, View, StyleSheet, ScrollView, Button, SafeAreaView, Dimensions, TextInput } from 'react-native';
